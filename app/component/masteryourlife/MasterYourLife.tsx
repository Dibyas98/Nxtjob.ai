        ...
        <main className='w-full px-3 h-[90vh]'>
            <section className='w-full h-full bg-[#EEEBFE] rounded-xl flex flex-col md:flex-row lg:flex-row gap-16'>
                ...
                <div className='w-full flex justify-center items-center'>
                    <div className='w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] md:w-[300px] md:h-[300px] lg:w-[400px] lg:h-[400px] border-2 rounded-full border-dashed border-white flex justify-center items-center relative ghost' >
                        <div className='w-[200px] h-[200px] sm:w-[200px] sm:h-[200px] md:w-[250px] md:h-[250px] lg:w-[300px] lg:h-[300px] bg-[#E2DBFD]  rounded-full'>
                        </div>
